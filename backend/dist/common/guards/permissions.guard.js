...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        ...
        if ((_a = user === null || user === void 0 ? void 0 : user.roles) === null || _a === void 0 ? void 0 : _a.includes('admin'))
            return true;
        return requiredPermissions.some(permission => { var _a; return (_a = user === null || user === void 0 ? void 0 : user.permissions) === null || _a === void 0 ? void 0 : _a.includes(permission); });
    }
};
