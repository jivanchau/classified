...
const DEFAULT_PERMISSIONS: { name: string; description: string }[] = [
  ...
  { name: 'features_options.read', description: 'Read feature options' },
  { name: 'features_options.create', description: 'Create feature options' },
  { name: 'features_options.update', description: 'Update feature options' },
  { name: 'features_options.delete', description: 'Delete feature options' },
  { name: 'cities.read', description: 'Read cities' },
  { name: 'cities.create', description: 'Create cities' },
  { name: 'cities.update', description: 'Update cities' },
  { name: 'cities.delete', description: 'Delete cities' },
  { name: 'locations.read', description: 'Read locations' },
  { name: 'locations.create', description: 'Create locations' },
  { name: 'locations.update', description: 'Update locations' },
